...
> Knitter, Daniel, (`r format(Sys.Date(), "%Y")`). _Emacs, rrtools, and reproducible research_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at https://github.com/dakni/EmacsEssay
